...
const theme: DefaultTheme = {
	colors: {
		...
		inputHoverBorderColor: palette.grayColor[700],
		...
		inputReadOnlyBackgroundColor: palette.grayColor[75],
		inputReadOnlyBorderColor: palette.grayColor[75],
		...
		inputGroupInteractiveBackgroundColor: palette.informationColor[100],
