...
<li>Try to make the text as short as possible and include the most critical or meaningful info to make reading easier. Add a popup to display detailed info.</li>
<li>If the tooltip has more than one sentence, use punctuations/periods.</li>
  </ul>
  </Use.Do>
	<Use.Dont>
  <ul>
...
<li>Don't use tooltips for information that is valid to task completion, for example field or password requirements. Such info essential to a frictionless user experience should always be present on the screen.</li>
<li>Don't use period at the end of a tooltip even if it's a complete sentence in order not to overload the interface.</li>
  </ul>
  </Use.Dont>
</Use>
