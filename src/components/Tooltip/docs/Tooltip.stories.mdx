...
<Use>
	...
	<Use.Dont>
		<ul>
			...
			<li>Don't use tooltips for information that is valid to task completion, e.g. field or password requirements. Such info essential to a frictionless user experience should always be present on the screen.</li>
