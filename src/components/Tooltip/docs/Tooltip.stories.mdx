...
<Use>
	<Use.Do>
		<ul>
			...
			<li>Try to make the text as short as possible and include the most critical or meaningful info to make reading easier.
			Add a popup or "See/show more" to display detailed info where necessary.</li>
	...
	<Use.Dont>
		<ul>
			...
			<li>If the tooltip is one sentence, don't use a period at the end even if it's a complete sentence in order not to overload the interface.</li>
		</ul>
  </Use.Dont>
</Use>
