...
<Use>
	<Use.Do>
		<ul>
			...
			<li>
				Choose specific words over vague words: “Try it now” for example is a common call to action (CTA), but
				doesn’t really tell the user what will happen next. It might be too vague. Use your
				judgement according to what the user should be doing when they click the button.
			</li>
			<li>
