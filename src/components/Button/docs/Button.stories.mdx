...
<Canvas>
	...
	<Story name="primary--icon">
		<Button.Primary onClick={action('clicked')} icon="plus">
			Button with icon
		</Button.Primary>
	</Story>
...
<Canvas>
	...
	<Story name="destructive--icon">
		<Button.Destructive onClick={action('clicked')} icon="plus">
			Button with icon
		</Button.Destructive>
	</Story>
...
<Canvas>
	...
	<Story name="secondary--icon">
		<Button.Secondary onClick={action('clicked')} icon="plus">
			Button with icon
		</Button.Secondary>
	</Story>
...
<Canvas>
	...
	<Story name="ghost--icon">
		<Button.Ghost onClick={action('clicked')} icon="plus">
			Button with icon
		</Button.Ghost>
	</Story>
	...
	<Story name="ghost--disabled-focusable">
...
<Canvas>
	<Story name="basic">
		...
		<Tooltip title="Relevant description of the basic button with icon">
			<Button onClick={action('clicked')} icon={'plus'}>
				Basic Button
			</Button>
		</Tooltip>
		<Tooltip title="Relevant description of the small button">
			<Button small onClick={action('clicked')}>
				Small Button
			</Button>
		</Tooltip>
		<Tooltip title="Relevant description of the disabled button">
			<Button disabled onClick={action('clicked')}>
				Disabled Button
			</Button>
		</Tooltip>
		<Tooltip title="Relevant description of the disabled focusable button">
