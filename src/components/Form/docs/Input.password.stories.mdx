...
<Meta title="Components|Form/Field/Input/Password" />
...
<Preview>
    <Story name="default">
        <Form.Password label="Checkbox" />
    </Story>
    <Story name="disabled">
        <Form.Password label="Disabled Checkbox" disabled />
    </Story>
    <Story name="read-only">
        <Form.Password label="Read-Only Checkbox" readOnly />
    </Story>
</Preview>
