...
Otherwise, consider <a href="/?path=/docs/components-form-fields-checkbox--default-story">checkboxes</a>, <a href="/?path=/docs/components-form-fields-switch--default-story">switch</a> or a <a href="/?path=/docs/components-form-fields-select--default-story">select</a>.
...
Press <kbd>TABS</kbd> or <kbd>Shift</kbd> + <kbd>TABS</kbd> to navigate between radio buttons.
