...
Otherwise, consider <a href="/docs/components-form-fields-checkbox">checkboxes</a>, <a href="/docs/components-form-fields-switch">switch</a> or a <a href="/docs/components-form-fields-select">select</a>.
