...
Inline messages interrupt the user to deliver a communication. They can be notifications, alerts, inline validation, or error messages.
...
<li>Get right to the point. Be brief but also super literal. Say what exactly happened and what the user needs to do to fix the error.</li>
  </ul>
  </Use.Do>
	<Use.Dont>
  <ul>
<li>Don’t includ extra details about why the error happened—give only the info that users need to know.</li>
  </ul>
  </Use.Dont>
</Use>
