import { DocsContainer, Meta, Preview, Props, Story } from '@storybook/addon-docs/blocks';
...
<ColorPalette>
	<ColorItem title="theme.color.palette" subtitle="Inline message colors" colors={{
	    Error: tokens.colors.chesnutRose,
		Warning: tokens.colors.jaffa,
		Success: tokens.colors.rioGrande,
