...
<ul>
    <li>Field-validation errors appear when a user enters info in a form field, but it isn’t formatted correctly.</li>
    <li>System errors appear when the entire application is having trouble, like when something is down or a user’s data is missing through no fault of their own.</li>
</ul>
