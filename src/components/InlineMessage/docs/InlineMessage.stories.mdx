...
<ul>
	...
	<li>System errors appear when the entire application is having trouble, like when a website is down or a user’s data is missing through no fault of their own.</li>
<ul>
