...
Link is used for navigation. If you use a link for triggering an action on the page, you must consider using a [Button](/?path=/docs/components-button--primary) instead.

Need to be convinced? Please take the time to read [article](https://marcysutton.com/links-vs-buttons-in-modern-web-applications) from Marcy Sutton.
