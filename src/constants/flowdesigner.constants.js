...
export const FLOWDESIGNER_NODE_SET_GRAPHICAL_ATTRIBUTES = 'FLOWDESIGNER_NODE_SET_GRAPHICAL_ATTRIBUTES';
export const FLOWDESIGNER_NODE_REMOVE_GRAPHICAL_ATTRIBUTES = 'FLOWDESIGNER_NODE_REMOVE_GRAPHICAL_ATTRIBUTES';
...
export const FLOWDESIGNER_PORT_SET_GRAPHICAL_ATTRIBUTES = 'FLOWDESIGNER_PORT_SET_GRAPHICAL_ATTRIBUTES';
export const FLOWDESIGNER_PORT_REMOVE_GRAPHICAL_ATTRIBUTES = 'FLOWDESIGNER_PORT_REMOVE_GRAPHICAL_ATTRIBUTES';
...
export const FLOWDESIGNER_LINK_SET_GRAPHICAL_ATTRIBUTES = 'FLOWDESIGNER_LINK_SET_GRAPHICAL_ATTRIBUTES';
export const FLOWDESIGNER_LINK_REMOVE_GRAPHICAL_ATTRIBUTES = 'FLOWDESIGNER_LINK_REMOVE_GRAPHICAL_ATTRIBUTES';
