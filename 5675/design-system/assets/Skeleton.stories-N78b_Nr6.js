import{j as e}from"./index-DqyI3zNy.js";import"./DialogBackdrop-Bbhqy77d.js";import{F as j,G as k,H as u,J as h,K as c,M as z,N as y,S as m,d as x,e as s}from"./Skeleton-DhSiadqt.js";import"./iframe-BqCCNGDC.js";import"./useCopyToClipboard-DqYYtEeu.js";import"./index-3dZT5jlp.js";import"./TalendDesignTokens-JgHEBmOa.js";const X={title:"Feedback/Skeleton",component:j},B=t=>e.jsx(k,{...t}),v=t=>e.jsx(u,{...t}),H=t=>e.jsx(h,{...t}),M=t=>e.jsx(c,{...t}),I=t=>e.jsx(z,{...t}),b=t=>e.jsx(y,{...t}),a=B.bind({});a.args={size:"M"};a.argTypes={size:{options:["M","S"],control:{type:"select"},description:'optional (default is "M")'}};const r=v.bind({});r.args={size:"M"};r.argTypes={size:{options:["M","S","XS"],control:{type:"select"},description:'optional (default is "M")'}};const o=H.bind({});o.args={size:"L"};o.argTypes={size:{options:["L","M","S"],control:{type:"select"},description:'optional (default is "L")'},width:{options:["100","XL","L","M","S","XS"],control:{type:"select"},description:"optional"}};const n=M.bind({});n.args={size:"M"};n.argTypes={size:{options:["M","S"],control:{type:"select"},description:'optional (default is "M")'},width:{options:["100","XL","L","M","S","XS"],control:{type:"select"},description:"optional"}};const i=I.bind({});i.args={isCircle:!0,height:"3rem",width:"20%"};const l=b.bind({}),S=()=>e.jsxs(m,{gap:"XS",align:"center",children:[e.jsx(k,{}),e.jsx(k,{size:"S"})]}),p=()=>e.jsxs(m,{gap:"XS",align:"center",children:[e.jsx(u,{}),e.jsx(u,{size:"S"}),e.jsx(u,{size:"XS"})]}),d=()=>e.jsxs(x,{gap:"XS",align:"stretch",children:[e.jsx(s,{variant:"heading"}),e.jsx(s,{variant:"paragraph"}),e.jsxs(x,{gap:"XS",padding:{y:"XS",x:0},children:[e.jsx(s,{variant:"heading",size:"M"}),e.jsx(s,{variant:"paragraph"}),e.jsx(s,{variant:"paragraph"}),e.jsx(s,{variant:"button"})]})]}),g=()=>e.jsxs(x,{gap:"XS",align:"stretch",children:[e.jsx(h,{}),e.jsxs(x,{gap:"XXS",children:[e.jsx(c,{}),e.jsx(c,{}),e.jsx(c,{})]}),e.jsxs(m,{gap:"XS",justify:"end",children:[e.jsx("div",{style:{width:"50%"}}),e.jsxs(m,{gap:"XS",align:"center",children:[e.jsx(c,{size:"S"}),e.jsx(k,{})]})]})]});a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
