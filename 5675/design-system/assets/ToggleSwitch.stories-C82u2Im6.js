import{j as e}from"./index-nXv0R8um.js";import{a as u}from"./iframe-DGvyPnos.js";import{F as t,e as h,I as S,a as b}from"./Dialog-DH8n1DVd.js";import"./index-D5CQICtx.js";import"./useCopyToClipboard-CBbDwwBs.js";import"./TalendDesignTokens-JgHEBmOa.js";import{u as m}from"./index.esm-C5deLdPL.js";const w={title:"Form/Fields/ToggleSwitch",component:t.ToggleSwitch},i=()=>e.jsxs(b,{gap:"M",justify:"stretch",align:"stretch",children:[e.jsx(t.ToggleSwitch,{placeholder:"Placeholder",name:"time",label:"ToggleSwitch"}),e.jsx(t.ToggleSwitch,{placeholder:"Placeholder",name:"time",label:"ToggleSwitch disabled",disabled:!0}),e.jsx(t.ToggleSwitch,{placeholder:"Placeholder",name:"time",label:"ToggleSwitch read-only",readOnly:!0}),e.jsx(t.ToggleSwitch,{name:"time",label:"ToggleSwitch checked",defaultChecked:!0}),e.jsx(t.ToggleSwitch,{name:"time",label:"ToggleSwitch checked disabled",defaultChecked:!0,disabled:!0}),e.jsx(t.ToggleSwitch,{name:"time",label:"ToggleSwitch checked read-only",defaultChecked:!0,readOnly:!0})]}),a=()=>e.jsxs(e.Fragment,{children:[e.jsx(t.ToggleSwitch,{placeholder:"Placeholder",name:"time",label:"ToggleSwitch inline",isInline:!0}),e.jsx("span",{children:" "}),e.jsx(t.ToggleSwitch,{placeholder:"Placeholder",name:"time",label:"ToggleSwitch inline",isInline:!0,defaultChecked:!0})]}),r=()=>e.jsx("div",{style:{width:"200px"},children:e.jsx(t.ToggleSwitch,{placeholder:"Placeholder",name:"time",label:"Label with a lot of content, too much probably, and most certainly enough to generate a line break in this small box."})}),c=()=>{const{register:o,watch:s}=m(),d=s("option-a");return e.jsxs(t,{children:[e.jsxs(t.Fieldset,{legend:"Control switch state",required:!0,children:[e.jsx(t.ToggleSwitch,{label:"Toggle all",...o("option-a")}),e.jsx(t.ToggleSwitch,{label:"Controlled switch",checked:d,...o("option-b")})]}),e.jsx(t.Buttons,{children:e.jsx(h,{onClick:()=>{},type:"submit",children:"Submit"})})]})},n=()=>{const{register:o,handleSubmit:s,watch:d}=m(),[g,p]=u.useState(),l=d();return e.jsxs(t,{onSubmit:s(p),children:[g&&e.jsx(S,{title:"Form data",description:JSON.stringify(g,null,2),withBackground:!0}),e.jsxs(t.Fieldset,{legend:"Enabled",children:[e.jsx(t.ToggleSwitch,{label:"Option a",...o("option-a"),checked:l["option-a"]}),e.jsx(t.ToggleSwitch,{label:"Option b",defaultChecked:!0,...o("option-b"),checked:l["option-b"]})]}),e.jsxs(t.Fieldset,{legend:"Read only",readOnly:!0,children:[e.jsx(t.ToggleSwitch,{label:"Option c",...o("option-c"),checked:l["option-c"]}),e.jsx(t.ToggleSwitch,{label:"Option d",defaultChecked:!0,...o("option-d"),checked:l["option-d"]})]}),e.jsxs(t.Fieldset,{legend:"Disabled",disabled:!0,children:[e.jsx(t.ToggleSwitch,{label:"Option e",disabled:!0,...o("option-e"),checked:l["option-e"]}),e.jsx(t.ToggleSwitch,{label:"Option f",defaultChecked:!0,disabled:!0,...o("option-f"),checked:l["option-f"]})]}),e.jsx(t.Buttons,{children:e.jsx(h,{onClick:()=>{},type:"submit",children:"Submit"})})]})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`() => <StackVertical gap="M" justify="stretch" align="stretch">
...
}`,...n.parameters?.docs?.source}}};const F=["ToggleSwitchStates","ToggleSwitchInline","ToggleSwitchWithLongLabel","ToggleSwitchControlled","ToggleSwitchReactHooksForm"],O=Object.freeze(Object.defineProperty({__proto__:null,ToggleSwitchControlled:c,ToggleSwitchInline:a,ToggleSwitchReactHooksForm:n,ToggleSwitchStates:i,ToggleSwitchWithLongLabel:r,__namedExportsOrder:F,default:w},Symbol.toStringTag,{value:"Module"}));export{O as S,i as T,a,r as b,c,n as d};
