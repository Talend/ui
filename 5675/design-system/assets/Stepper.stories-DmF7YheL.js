import{j as e}from"./index-DqyI3zNy.js";import{V as t,D as l}from"./DialogBackdrop-Bbhqy77d.js";import{d}from"./Skeleton-DhSiadqt.js";import"./iframe-BqCCNGDC.js";import"./useCopyToClipboard-DqYYtEeu.js";import"./index-3dZT5jlp.js";import"./TalendDesignTokens-JgHEBmOa.js";const S={title:"Navigation/Stepper/Stepper",component:t},p=()=>e.jsxs(t,{children:[e.jsx(t.Step.Validated,{title:"Validated step"}),e.jsx(t.Step.InProgress,{title:"Current step"}),e.jsx(t.Step.Enabled,{title:"Next step"}),e.jsx(t.Step.Enabled,{title:"Next step"})]}),s=()=>e.jsxs(t.Horizontal,{children:[e.jsx(t.Step.Validated,{title:"Validated step"}),e.jsx(t.Step.InProgress,{title:"Current step"}),e.jsx(t.Step.Enabled,{title:"Next step"})]}),a=()=>e.jsxs(d,{gap:"M",justify:"center",align:"center",children:[e.jsx("h4",{children:"Vertical stepper"}),e.jsxs(t,{children:[e.jsx(t.Step.Validated,{title:"Validated step with copy that breaks the width limit"}),e.jsx(t.Step.InProgress,{title:"Current step with copy that breaks the width limit"})]}),e.jsx(l,{}),e.jsx("h4",{children:"Horizontal stepper"}),e.jsxs(t.Horizontal,{children:[e.jsx(t.Step.Validated,{title:"Validated step with copy that breaks the width limit"}),e.jsx(t.Step.InProgress,{title:"Current step with copy that breaks the width limit"})]})]}),r=({variant:i,...o})=>{const n=t[i];return n.displayName=`Stepper.${i}`,e.jsxs(n,{...o,children:[e.jsx(t.Step.Validated,{title:"Validated"}),e.jsx(t.Step.InProgress,{title:"In progress"}),e.jsx(t.Step.Enabled,{title:"Enabled"})]})};r.args={variant:"Vertical",currentStepIndex:1};r.argTypes={variant:{description:"Stepper variation",options:["Vertical","Horizontal"],control:{type:"select"}},currentStepIndex:{description:"Current step index",control:{type:"number"}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`() => <Stepper>
        ...
        <Stepper.Step.Enabled title="Next step" />
    </Stepper>`,...p.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => <Stepper.Horizontal>
        <Stepper.Step.Validated title="Validated step" />
        <Stepper.Step.InProgress title="Current step" />
        <Stepper.Step.Enabled title="Next step" />
    </Stepper.Horizontal>`,...s.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`() => <StackVertical gap="M" justify="center" align="center">
    ...
    </StackVertical>`,...a.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`({
  variant,
  ...props
}: any) => {
...
}`,...r.parameters?.docs?.source}}};const c=["Vertical","Horizontal","Overflows","Usage"],b=Object.freeze(Object.defineProperty({__proto__:null,Horizontal:s,Overflows:a,Usage:r,Vertical:p,__namedExportsOrder:c,default:S},Symbol.toStringTag,{value:"Module"}));export{s as H,a as O,b as S,r as U,p as V};
