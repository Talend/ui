import{I as S,r as g,P as h,b as p,j as t,al as f,M as u}from"./iframe-ZtC4i0Bp.js";import{o as C}from"./omit-Z8VTCKnc.js";import"./preload-helper-PPVm8Dsz.js";const l="value",c=new S.Map({[l]:void 0}),m="Container(Slider)";let x=class extends g.Component{static displayName=m;static propTypes={...p.propTypes,id:h.string,value:h.number};static defaultProps={value:0};constructor(e){super(e),this.onChange=this.onChange.bind(this),this.onAfterChange=this.onAfterChange.bind(this)}onAfterChange(e){this.props.onAfterChange&&this.props.onAfterChange(e)}onChange(e){this.props.setState(o=>o.state.set(l,e)),this.props.onChange&&this.props.onChange(e)}render(){const e=this.props.state||c,o={...C(this.props,p.INJECTED_PROPS),value:e.get(l,this.props.value),onChange:this.onChange,onAfterChange:this.onAfterChange};return t.jsx(f,{...o})}};const s=p({componentId:i=>i.id,defaultState:c,omitCMFProps:!0,withComponentRegistry:!0,withDispatch:!0,withDispatchActionCreator:!0,withComponentId:!0})(x);function y(i,e){return i.cmf.components.getIn([m,e],c)}function v(i,e){return y(i,e).get(l,"")}s.selectors={getComponentState:y,getValue:v};const b=["talend-smiley-angry","talend-smiley-unhappy","talend-smiley-neutral","talend-smiley-satisfied","talend-smiley-enthusiast"],a={paddingTop:"25px",paddingBottom:"25px",borderBottom:"1px dashed grey"},n={paddingLeft:"10px"},j=[{id:"icon1",label:"Click Me",icon:"talend-smiley-angry","data-feature":"action",link:!0,hideLabel:!0},{id:"icon2",label:"Click Me",icon:"talend-smiley-neutral","data-feature":"action",link:!0,hideLabel:!0},{id:"icon3",label:"Click Me",icon:"talend-smiley-neutral","data-feature":"action",link:!0,hideLabel:!0},{id:"icon4",label:"Click Me",icon:"talend-smiley-neutral","data-feature":"action",link:!0,hideLabel:!0},{id:"icon5",label:"Click Me",icon:"talend-smiley-satisfied","data-feature":"action",link:!0,hideLabel:!0}],A=i=>`${i}`,T=new u,d=new u({value:50}),I={title:"Slider"},r=()=>t.jsxs("div",{style:{padding:"0 0.75rem"},children:[t.jsxs("div",{style:a,children:[t.jsx("p",{style:n,children:"default"}),t.jsx(s,{id:"slider1",initialState:d})]}),t.jsxs("div",{style:a,children:[t.jsx("p",{style:n,children:"with some icons"}),t.jsx(s,{id:"slider2",captionIcons:b,initialState:T})]}),t.jsxs("div",{style:a,children:[t.jsx("p",{style:n,children:"with some actions icons"}),t.jsx(s,{id:"slider3",captionActions:j,initialState:d})]}),t.jsxs("div",{style:a,children:[t.jsx("p",{style:n,children:"with step number"}),t.jsx(s,{id:"slider4",initialState:d,captionsFormat:A,captionTextStepNumber:5})]})]});r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`() => <div style={{
  padding: '0 0.75rem'
}}>
