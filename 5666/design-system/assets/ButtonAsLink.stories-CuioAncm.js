import{j as t}from"./index-BjJ1gK4Q.js";import{B as S,L as B}from"./index-_8PjVJwf.js";import"./DialogBackdrop-DrwYyHz3.js";import{g as c,h as L,i as e,T as j,S as A,a as n,j as y,k as g}from"./Skeleton-BJ-qTseU.js";import"./iframe-BWotmeKP.js";import"./useCopyToClipboard-Bz_CjoHD.js";import"./index-CKY2Phf9.js";import"./TalendDesignTokens-JgHEBmOa.js";import"./index-V1_MM1Tg.js";import"./preload-helper-PPVm8Dsz.js";const l={children:"Link label",href:"./",target:"_blank",icon:"talend-plus",size:"M"},u={children:{control:{type:"text"}},href:{control:{type:"text"}},target:{options:["_blank","_self","_parent","_top"],control:{type:"select"},description:"optional"},icon:{control:{type:"text"},description:"optional"},size:{options:["M","S"],control:{type:"select"},description:'optional (default is "M")'}},M={component:c,title:"Clickable/ButtonAsLink",parameters:{actions:{argTypesRegex:"^on[A-Z].*"}},args:l,argTypes:u},f=r=>t.jsx(c,{...r}),x=r=>t.jsx(L,{...r}),b=r=>t.jsx(g,{...r}),T=r=>t.jsx(y,{...r}),a=f.bind({});Object.assign(a,{args:l,argTypes:u});const s=T.bind({});Object.assign(s,{args:l,argTypes:u});const o=x.bind({});Object.assign(o,{args:l,argTypes:u});const i=b.bind({});Object.assign(i,{args:l,argTypes:u});const p=r=>t.jsx(j,{title:"Relevant information about contacting the support",children:t.jsx(c,{href:"/support",target:"_blank",icon:"talend-bubbles",...r,children:"Contact support"})}),d=()=>t.jsxs(A,{gap:"S",children:[t.jsx(e,{variant:"primary",href:"https://talend.com",children:"Primary Button as link"}),t.jsx(e,{variant:"destructive",href:"https://talend.com",children:"Destructive Button as link"}),t.jsx(e,{variant:"secondary",href:"https://talend.com",children:"Secondary Button as link"}),t.jsx(e,{variant:"tertiary",href:"https://talend.com",children:"Tertiary Button as link"})]}),h=()=>t.jsx(S,{children:t.jsx(L,{as:t.jsx(B,{to:"home"}),children:"Home"})}),m=()=>t.jsx(S,{children:t.jsx(e,{variant:"destructive",icon:"talend-plus-circle",as:t.jsx(B,{to:"home"}),children:"Home"})}),k=()=>t.jsxs(A,{gap:"S",justify:"spaceBetween",align:"stretch",children:[t.jsxs(n,{gap:"S",justify:"spaceAround",align:"center",children:[t.jsx("p",{children:" "}),t.jsx("h3",{children:"M"}),t.jsx("h3",{children:"S"})]}),t.jsxs(n,{gap:"S",justify:"start",align:"center",children:[t.jsx("h3",{children:"Primary"}),t.jsx(c,{icon:"upload",href:"/",children:"Label"}),t.jsx(c,{icon:"upload",href:"/",size:"S",children:"Label"})]}),t.jsxs(n,{gap:"S",justify:"start",align:"center",children:[t.jsx("h3",{children:"Destructive"}),t.jsx(y,{icon:"upload",href:"/",children:"Label"}),t.jsx(y,{icon:"upload",href:"/",size:"S",children:"Label"})]}),t.jsxs(n,{gap:"S",justify:"start",align:"center",children:[t.jsx("h3",{children:"Secondary"}),t.jsx(L,{icon:"upload",href:"/",children:"Label"}),t.jsx(L,{icon:"upload",href:"/",size:"S",children:"Label"})]}),t.jsxs(n,{gap:"S",justify:"start",align:"center",children:[t.jsx("h3",{children:"Tertiary"}),t.jsx(g,{icon:"upload",href:"/",children:"Label"}),t.jsx(g,{icon:"upload",href:"/",size:"S",children:"Label"})]})]});a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
  ...
  return <ButtonTertiaryAsLink {...args} />;
    ...
    </StackHorizontal>`,...d.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => <BrowserRouter>
        <ButtonSecondaryAsLink as={<Link to="home" />}>Home</ButtonSecondaryAsLink>
    </BrowserRouter>`,...h.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`() => <BrowserRouter>
        <ButtonAsLink variant="destructive" icon="talend-plus-circle" as={<Link to="home" />}>
            Home
        </ButtonAsLink>
    </BrowserRouter>`,...m.parameters?.docs?.source}}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`() => <StackHorizontal gap="S" justify="spaceBetween" align="stretch">
    ...
    </StackHorizontal>`,...k.parameters?.docs?.source}}};const O=["PrimaryAsLink","DestructiveAsLink","SecondaryAsLink","TertiaryAsLink","TooltipButton","VariantComponent","ButtonAsRouterLink","ButtonAsRouterLinkVariant","Variations"];export{h as ButtonAsRouterLink,m as ButtonAsRouterLinkVariant,s as DestructiveAsLink,a as PrimaryAsLink,o as SecondaryAsLink,i as TertiaryAsLink,p as TooltipButton,d as VariantComponent,k as Variations,O as __namedExportsOrder,M as default};
