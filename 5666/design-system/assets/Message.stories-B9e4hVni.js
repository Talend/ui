import{j as t}from"./index-BjJ1gK4Q.js";import{M as y,w as m,x as f,y as u,z as k,A as g,C as S,E as r,F as b,G as C,H as h,I as D,J as p,K as M}from"./DialogBackdrop-DrwYyHz3.js";import{S as i}from"./Skeleton-BJ-qTseU.js";import"./iframe-BWotmeKP.js";import"./useCopyToClipboard-Bz_CjoHD.js";import"./index-CKY2Phf9.js";import"./TalendDesignTokens-JgHEBmOa.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,T={component:y,title:"Messaging/Message"},n=()=>t.jsxs(i,{gap:"M",children:[t.jsx(g,{title:"All good",titleInfo:"system",description:"This component is well configured",link:{href:"https://talend.com",children:"Learn more"},action:{children:"See",onClick:e("action clicked")},additionalIconAction:{children:"Dismiss",onClick:e("dismiss clicked"),icon:"trash"},children:t.jsxs(i,{gap:"S",children:[t.jsx(S,{children:"Good"})," ",t.jsx(r,{children:"Default"})]})}),t.jsx(b,{title:"Very very long title with reflow because it’s too long please don’t do that it’s way too long.",titleInfo:"1 minute ago",description:"There is an issue with the component configuration",link:{href:"https://talend.com",children:"Learn more"},additionalIconAction:{children:"Dismiss",onClick:e("dismiss clicked"),icon:"trash"},children:t.jsxs(i,{gap:"S",children:[t.jsx(C,{children:"Error"})," ",t.jsx(r,{children:"Default"})]})}),t.jsx(h,{title:"Type incompatibilities",description:"Maybe resolve this issue before doing anything else",link:{href:"https://talend.com",children:"Learn more"},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]},children:t.jsxs(i,{gap:"S",children:[t.jsx(D,{children:"Bindings"})," ",t.jsx(r,{children:"Default"})]})}),t.jsx(p,{title:"Auto mapping",description:"Some fields has been auto mapped",link:{href:"https://talend.com",children:"Learn more"},action:{children:"Dismiss",onClick:e("action clicked")},children:t.jsx(i,{gap:"S",children:t.jsx(r,{children:"Default"})})})]}),a=()=>t.jsxs(i,{gap:"M",children:[t.jsx(g,{link:{href:"https://talend.com",children:"Learn more"},description:"This component is well configured",children:t.jsx(M,{children:"Beta"})}),t.jsx(b,{description:"There is an issue with the component configuration",action:{children:"See",onClick:e("action clicked")},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]}}),t.jsx(h,{description:"Maybe resolve this issue before doing anything else"}),t.jsx(p,{title:"Auto mapping",description:"Some fields has been auto mapped"})]}),A=d=>t.jsx(p,{...d}),o=A.bind({});o.argTypes={action:{control:{type:"object"}},additionalDropdownActions:{control:{type:"object"}},title:{control:{type:"text"}},description:{control:{type:"text"}},link:{control:{type:"object"}},children:{control:{type:"text"},description:"optional"}};o.args={action:{children:"See",onClick:()=>{}},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]},title:"Information Title",description:"Maybe resolve this issue before doing anything else",link:{href:"https://talend.com",children:"Learn more"}};const c=()=>t.jsxs(i,{gap:"M",children:[t.jsx(m,{description:"Try resolving it this way or consult the documentation for more info.",title:"Success",action:{children:"See all (3)",onClick:e("action clicked")},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]}}),t.jsx(f,{title:"Error",description:"(n) input fields have been automatically mapped to an output.",action:{children:"See all (3)",onClick:e("action clicked")},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]}}),t.jsx(u,{title:"Warning",description:"Try resolving it this way or consult the documentation for more info.",action:{children:"See all (3)",onClick:e("action clicked")},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]}}),t.jsx(k,{description:"(n) input fields have been automatically mapped to an output.",title:"Information",action:{children:"See all (3)",onClick:e("action clicked")},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]}})]}),s=()=>t.jsxs(i,{gap:"M",children:[t.jsx(m,{action:{children:"See all (3)",onClick:e("action clicked")},title:"Success",description:"(n) input fields have been automatically mapped to an output."}),t.jsx(u,{title:"Warning",description:"Try resolving it this way or consult the documentation for more info.",action:{children:"See all (3)",onClick:e("action clicked")},additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]}})]}),x=d=>t.jsx(k,{...d}),l=x.bind({});l.args={action:{children:"See",onClick:()=>{}},title:"Information Title",description:"Maybe resolve this issue before doing anything else",additionalDropdownActions:{"aria-label":"Additional actions",items:[{label:"Select all",type:"button",onClick:e("select all clicked")},{label:"Dismiss",type:"button",onClick:e("dismiss clicked")},{label:"Delete",type:"button",onClick:e("delete clicked")}]}};l.argTypes={action:{control:{type:"object"}},title:{control:{type:"text"}},description:{control:{type:"text"}},additionalDropdownActions:{control:{type:"object"}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => <StackHorizontal gap="M">
