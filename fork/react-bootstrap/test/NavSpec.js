...
describe('<Nav>', () => {
	...
	describe('keyboard navigation', () => {
		...
		it('should focus the next tab on arrow key', () => {
			...
			ReactTestUtils.Simulate.keyDown(anchors[0], { key: 'ArrowRight' });
		...
		it('should focus the previous tab on arrow key', () => {
			...
			ReactTestUtils.Simulate.keyDown(anchors[4], { key: 'ArrowLeft' });
		...
		it('should wrap to the next tab on arrow key', () => {
			...
			ReactTestUtils.Simulate.keyDown(anchors[4], { key: 'ArrowDown' });
		...
		it('should wrap to the previous tab on arrow key', () => {
			...
			ReactTestUtils.Simulate.keyDown(anchors[0], { key: 'ArrowUp' });
	...
	describe('event keys', () => {
		it('should accept any number as an event key', () => {
			let instance;
			const selectSpy = sinon.spy(activeKey => instance.setProps({ activeKey }));
			instance = mount(
