...
import { bsStyles, bsSizes, getClassSet, prefix, _curry } from '../../src/utils/bootstrapUtils';
...
describe('bootstrapUtils', () => {
	...
	it('returns a classSet of bsClass, style and size', () => {
		expect(getClassSet({ bsClass: 'btn', bsSize: 'lg', bsStyle: 'primary' })).to.eql({
			btn: true,
			'btn-lg': true,
			'btn-primary': true,
		});
	...
	describe('bsStyles', () => {
		...
		it('should work with functional components', () => {
			...
			const Component = bsStyles(['minimal', 'boss', 'tartan'], 'tartan')(() => <span />);
