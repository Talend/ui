...
describe('<MenuItem>', () => {
	...
	it('renders divider not children', () => {
		...
		const instance = ReactTestUtils.renderIntoDocument(<MenuItem divider>Some child</MenuItem>);
		const node = ReactDOM.findDOMNode(instance);
	...
	it('renders menu item link', done => {
		...
		ReactTestUtils.Simulate.keyDown(anchor, { key: '1' });
	});
	...
	it('should pass through props', () => {
		let instance = ReactTestUtils.renderIntoDocument(
			<MenuItem className="test-class" href="#hi-mom!" title="hi mom!" style={{ height: 100 }}>
				Title
			</MenuItem>,
		);
	...
	it('Should set target attribute on anchor', () => {
		let instance = ReactTestUtils.renderIntoDocument(<MenuItem target="_blank">Title</MenuItem>);
	...
	it('should output an li', () => {
		let instance = ReactTestUtils.renderIntoDocument(<MenuItem>Title</MenuItem>);
