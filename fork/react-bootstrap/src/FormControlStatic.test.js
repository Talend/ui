...
describe('<FormControl.Static>', () => {
  it('should render correctly', () => {
    ...
    expect(
      document.querySelector('.form-control-static.my-form-control-static')
    ).toHaveTextContent('Static text');
  });
  ...
  it('should support custom componentClass', () => {
    ...
    expect(document.querySelector('.form-control-static')).toHaveTextContent(
      'Static text'
    );
  });
});
