import{j as e}from"./index-B9-qYGBk.js";import{u as l}from"./index-Da5wsJkm.js";import{M as c,C as i}from"./blocks-CAsCm6ut.js";import{U as s,F as o}from"./Use-BhZkufkg.js";import"./index-D5yYFgZ2.js";import"./DialogBackdrop-krg1g4kT.js";import{D as h}from"./Skeleton-DQMYC1Qs.js";import"./iframe-DMeIh28H.js";import"./useCopyToClipboard-CSXVrkkP.js";import"./TalendDesignTokens-JgHEBmOa.js";import{Basic as a,WithIcons as p,WithDividers as x,WithTitle as j,WithManyItems as m,WithLongText as u,WithRouterLinks as w}from"./Dropdown.stories-C91I-XEO.js";import{S as f}from"./Status.block-qp_iyHac.js";import"./index-DrATTtfC.js";import"./preload-helper-PPVm8Dsz.js";import"./dictionary-CKKJDmnH.js";import"./dictionary-CeEBddAU.js";import"./index-BzDf3bvz.js";import"./Statuses-Dlh6BiQa.js";function r(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...t.components};return s||d("Use",!1),s.Do||d("Use.Do",!0),e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Clickable/Dropdown",component:h}),`
`,e.jsx(f,{id:"dropdown"}),`
...
`,e.jsx(o,{src:"https://www.figma.com/file/IUeLBwjDCMkpdO7OtZ29u1/Dropdown?node-id=806%3A2186",alt:"zoning image for dropdown"}),`
`,e.jsx(n.h2,{id:"style",children:"Style"}),`
`,e.jsx(o,{src:"https://www.figma.com/file/IUeLBwjDCMkpdO7OtZ29u1/Dropdown?node-id=806%3A2112",alt:"Basic dropdown styles"}),`
...
`,e.jsx(o,{src:"https://www.figma.com/file/IUeLBwjDCMkpdO7OtZ29u1/Dropdown?node-id=808%3A2230",alt:"dropdown behaviors"}),`
`,e.jsx(n.h2,{id:"content",children:"Content"}),`
`,e.jsx(s,{children:e.jsx(s.Do,{children:e.jsx("ul",{children:e.jsx("li",{children:e.jsx(n.p,{children:`Keep menu items to a single line of text as much as possible. If not, when the label is too
...
`,e.jsx(i,{height:"25rem",of:w})]})}function P(t={}){const{wrapper:n}={...l(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}function d(t,n){throw new Error("Expected "+(n?"component":"object")+" `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{P as default};
