import{j as i}from"./iframe-BDzYBMaC.js";import{T as j}from"./DialogBackdrop-AC0WYH6J.js";import{J as P,O as q,P as _}from"./Skeleton-DkqwJxpk.js";import{a as D,S as y}from"./StackItem-CEPyEpFk.js";import"./QualityBar.component-DQinLpxB.js";import"./preload-helper-PPVm8Dsz.js";import"./Tooltip-DeLq5SN8.js";import"./index-DNAcat5m.js";import"./removeClass-B-DUduzN.js";import"./interopRequireDefault-CBIuXflU.js";import"./Transition-66tmR4yx.js";import"./RatioBar.component-DDlYUqlR.js";const o={"rich-radio-button":"_rich-radio-button_108ms_1","rich-radio-button__icon":"_rich-radio-button__icon_108ms_21","rich-radio-button__illustration":"_rich-radio-button__illustration_108ms_27","rich-radio-button__logo":"_rich-radio-button__logo_108ms_28","rich-radio-button__wrapper":"_rich-radio-button__wrapper_108ms_32","rich-radio-button__input":"_rich-radio-button__input_108ms_46"};function O({asset:t}){return t?.illustration?i.jsx("span",{className:o["rich-radio-button__illustration"],children:i.jsx(t.illustration,{})}):t?.logo?i.jsx(P,{name:t.logo,className:o["rich-radio-button__logo"]}):t?.name?i.jsx("span",{className:o["rich-radio-button__icon"],children:q({iconSrc:t.name||"",size:"L",...t})}):null}const a=({dataFeature:t,description:B,asset:b,id:f,isChecked:C=!1,isDisabled:W=!1,isReadOnly:I=!1,name:L,onChange:v,tags:k,title:x,"data-testid":A,"data-test":S})=>i.jsxs("label",{className:o["rich-radio-button__wrapper"],children:[i.jsx("input",{className:o["rich-radio-button__input"],type:"radio",id:f,name:L,disabled:W,readOnly:I,checked:C,"data-feature":t,"data-testid":A,"data-test":S,onChange:()=>v(f),"data-checked":C,onKeyDown:e=>{e.key==="Enter"&&(e.preventDefault(),v(f))}}),i.jsx("span",{className:o["rich-radio-button"],children:i.jsxs(D,{as:"span",gap:"XS",children:[i.jsx(O,{asset:b}),i.jsx("h4",{children:x}),B&&i.jsx("p",{children:B}),k&&i.jsx(y,{as:"span",gap:"XS",wrap:"wrap",children:k.map(e=>i.jsx(j,{variant:e.variant,children:e.name},e.name))})]})})]}),Q={component:a,title:"Form/RichRadioButton"},u=()=>i.jsx(a,{description:`Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
    Porro nihil delectus quaerat repellat saepe officiis id aut. 
    Culpa iste molestias optio nihil placeat magnam, odio modi earum est voluptas saepe?`,id:"richRadioButton",name:"richRadioButton",onChange:()=>{},title:"This is a title"}),p=()=>i.jsx(a,{description:`Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
        Porro nihil delectus quaerat repellat saepe officiis id aut. 
        Culpa iste molestias optio nihil placeat magnam, odio modi earum est voluptas saepe?`,id:"richRadioButtonWithTags",name:"richRadioButtonWithTags",onChange:()=>{},tags:[{name:"Tag 1"},{name:"Tag 2",variant:"information"},{name:"Tag 3",variant:"information"}],title:"This is a title"}),h=()=>i.jsx(a,{asset:{name:"user"},description:`Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
        Porro nihil delectus quaerat repellat saepe officiis id aut. 
        Culpa iste molestias optio nihil placeat magnam, odio modi earum est voluptas saepe?`,id:"richRadioButtonWithTagsAndIcon",name:"richRadioButtonWithTagsAndIcon",onChange:()=>{},title:"This is a title",tags:[{name:"Tag 1"},{name:"Tag 2",variant:"information"},{name:"Tag 3",variant:"information"}]}),g=()=>i.jsx(a,{asset:{illustration:_.IconDefault},description:`Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
        Porro nihil delectus quaerat repellat saepe officiis id aut. 
  ...
  name: 'Tag 3',
  variant: 'information'
}]} />`,...T.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => <RichRadioButton description="Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
    Porro nihil delectus quaerat repellat saepe officiis id aut. 
    Culpa iste molestias optio nihil placeat magnam, odio modi earum est voluptas saepe?" id={'checkedRichRadioButton'} isChecked={true} name={'checkedRichRadioButton'} onChange={() => {}} title="This is a title" />`,...s.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => <RichRadioButton description="Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
        Porro nihil delectus quaerat repellat saepe officiis id aut. 
  ...
  name: 'Tag 3',
  variant: 'information'
}]} />`,...l.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`() => <RichRadioButton asset={{
  name: 'user'
}} description="Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
        Porro nihil delectus quaerat repellat saepe officiis id aut. 
  ...
  name: 'Tag 3',
  variant: 'information'
}]} />`,...m.parameters?.docs?.source}}};const U=["DefaultStory","RichRadioButtonWithTags","RichRadioButtonWithTagsAndIcon","RichRadioButtonWithTagsAndIllustration","RichRadioButtonDisabled","RichRadioButtonReadOnly","CheckedRichRadioButton","CheckedRichRadioButtonWithTags","CheckedRichRadioButtonWithTagsAndIcon","CheckedRichRadioButtonWithTagsAndIllustration","CheckedRichRadioButtonWithTagsAndLogo","CheckedRichRadioButtonDisabled","CheckedRichRadioButtonReadOnly"];export{s as CheckedRichRadioButton,l as CheckedRichRadioButtonDisabled,m as CheckedRichRadioButtonReadOnly,n as CheckedRichRadioButtonWithTags,r as CheckedRichRadioButtonWithTagsAndIcon,c as CheckedRichRadioButtonWithTagsAndIllustration,d as CheckedRichRadioButtonWithTagsAndLogo,u as DefaultStory,R as RichRadioButtonDisabled,T as RichRadioButtonReadOnly,p as RichRadioButtonWithTags,h as RichRadioButtonWithTagsAndIcon,g as RichRadioButtonWithTagsAndIllustration,U as __namedExportsOrder,Q as default};
