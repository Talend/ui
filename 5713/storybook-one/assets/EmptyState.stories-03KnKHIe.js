...
`)&&(l=String(s).split(`
`).map(function(o,g){return g===0?o:""+R+o}).join(`
...
`:""}
  ...
  href: 'https://talend.com'
}} />`,...f.parameters?.docs?.source}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`() => <BrowserRouter>
        <EmptyStateLarge title="No preparations yet" description="Add a preparation to clean, format, and transform data prior to processing." action={{
    ...
    </BrowserRouter>`,..._.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`({
  illustration,
  title,
  description,
  link,
  ...
  return <EmptyStateMedium illustration={illustration} title={title} description={description} link={link} action={action} />;
}`,...h.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:'() => <EmptyStateSmall title="Create a preparation first" />',...v.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`() => <StackHorizontal gap="XS" align="center" justify="spaceBetween">
    ...
    </StackHorizontal>`,...y.parameters?.docs?.source}}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`(args: EmptyStateProps) => {
  switch (args.variant) {
    case 'L':
      {
        const {
...
}`,...E.parameters?.docs?.source}}};const gt=["Large","LargeWithLinkButton","MediumWithAction","Small","Demo","Usage"];export{y as Demo,f as Large,_ as LargeWithLinkButton,h as MediumWithAction,v as Small,E as Usage,gt as __namedExportsOrder,yt as default};
