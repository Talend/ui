import{m,j as t}from"./iframe-qu-nfhQI.js";import{A as e}from"./ActionDropdown.connect-BGKduVSE.js";import"./preload-helper-PPVm8Dsz.js";import"./actionOnClick-BT0Mp0Wd.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l={title:"AboutDropdown",args:{onSelect:d("selectAction")}};function o({onSelect:n}){const i={id:"injected-items",displayMode:"dropdown",label:"my injected items",onSelect:n,components:{itemsDropdown:[{component:"Action",actionId:"menu:first",withMenuItem:!0},{divider:!0},{component:"FilterBar",dockable:!1,docked:!1,withMenuItem:!0},{component:"Action",actionId:"menu:second"}]}},s={id:"immutable-items",displayMode:"dropdown",label:"my immutable items",onSelect:n,items:m([{id:"item1",label:"First immutable label"},{id:"item2",label:"2nd immutable"}])};return t.jsxs("div",{children:[t.jsx("p",{children:"ActionDropdown with items in the settings"}),t.jsx(e,{actionId:"menu:items-id"}),t.jsx("p",{children:"ActionDropdown with items from an expression"}),t.jsx(e,{actionId:"menu:items"}),t.jsx("p",{children:"ActionDropdown from setting and items from props"}),t.jsx(e,{actionId:"menu:first",actionIds:["menu:first","menu:second"]}),t.jsx("p",{children:"ActionDropdown from setting and a link into the items"}),t.jsx(e,{actionId:"action-dropdown:href"}),t.jsx("p",{children:"ActionDropdown with components"}),t.jsx(e,{...i}),t.jsx("p",{children:"ActionDropdown with immutable items"}),t.jsx(e,{...s})]})}o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`function Default({
  onSelect
}) {
