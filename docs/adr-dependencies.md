...
Add **a-dependency** under peerDependencies only if it is has to be installed and configured (so imported) into the project's code to make your library work.
