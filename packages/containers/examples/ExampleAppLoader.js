...
api.actionCreator.register('ac1', ac1);
api.actionCreator.register('ac2', ac2);

const ExampleAppLoader = {
	AppLoader: () => {
		const hasCollections = ['col1', 'col2'];
		const steps = [{ actionCreators: ['ac1'] }, { waitFor: ['col1'] }, { actionCreators: ['ac2'] }];
		return (
			<div>
