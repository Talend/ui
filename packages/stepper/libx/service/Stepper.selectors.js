...
function getStepsForResource(store, resourceType, resourceId) {
	return get(store, [STATE_KEY, getStepperKey({ resourceType, resourceId }), 'steps'], []);
}
function isResourceLoading(store, resourceType, resourceId) {
	return Stepper.isStepsLoading(getStepsForResource(store, resourceType, resourceId));
}
export { getStepsForResource, isResourceLoading };
//# sourceMappingURL=Stepper.selectors.js.map
