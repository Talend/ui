...
if (fs.existsSync(userBabelrc)) {
	...
	console.log('WARNING: you have your own babelrc. Please be sure you have included our babelrc:');
	console.log(`"extends": "${path.relative(process.cwd(), `${__dirname}/babelrc.json`)}"`);
} else {
