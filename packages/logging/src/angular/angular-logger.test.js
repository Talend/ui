...
angular.module('angular-logger.test', [angularLogger])
	...
	.controller('FailCtrl', ['$exceptionHandler', $exceptionHandler => {
		try {
...
describe('Angular logger', () => {
	...
	it('should log error', angular.mock.inject($controller => {
		// when
		$controller('FailCtrl');
		jest.runAllTimers();
