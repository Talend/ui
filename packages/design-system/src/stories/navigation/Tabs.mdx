...
<Canvas>
	<Story of={Stories.TabStandalone} />
</Canvas>

It also works for large Tabs if needed:

<Canvas withSource="closed">
	<Story of={Stories.TabStandaloneLarge} />
</Canvas>
...
<Canvas>
	<Story of={Stories.TabsWithComposition} />
</Canvas>

This method supports the same features as the API one:

<Canvas withSource="closed">
	<Story of={Stories.TabsWithCompositionLarge} />
</Canvas>
...
<Canvas withSource="closed">
	<Story of={Stories.TabsWithCompositionControlled} />
</Canvas>
