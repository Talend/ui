...
<<<<<<< HEAD:packages/storybook/src/design-system/Dropdown/Dropdown.mdx
import * as Stories from '@talend/design-system/src/components/Dropdown/Dropdown.stories';
=======
import * as Stories from './Dropdown.stories';
import { Status } from '../Status.block';
>>>>>>> master:packages/design-system/src/stories/clickable/Dropdown.mdx
