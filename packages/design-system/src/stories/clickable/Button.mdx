<<<<<<< HEAD:packages/storybook/src/design-system/Button/Button.mdx
import { ArgsTable, Meta, Canvas, Story } from '@storybook/addon-docs';
import { FigmaImage, Use } from '~docs';
import * as Stories from '@talend/design-system/src/components/Button/Button.stories';
=======
import { Meta, Canvas, Story, Controls } from '@storybook/blocks';
import { FigmaImage, Use } from '@talend/storybook-docs';
import * as Stories from './Button.stories';
import { Status } from '../Status.block';
>>>>>>> master:packages/design-system/src/stories/clickable/Button.mdx
