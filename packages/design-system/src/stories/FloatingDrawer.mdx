...
import { FigmaImage, FigmaIframe } from '@talend/storybook-docs';

import { FloatingDrawer, StackVertical, InlineMessageWarning } from '../';
...
<Canvas withSource="none">
	<Story story={Stories.WithDisclosure} />
</Canvas>

<Canvas withSource="none">
	<Story story={Stories.WithControlledVisibility} />
</Canvas>
