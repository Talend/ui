...
<Use>
	<Use.Do>Results not found.</Use.Do>
	<Use.Do>The connection is created successfully.</Use.Do>
	<Use.Dont>The search did not return any results.</Use.Dont>
	<Use.Dont>You have created the connection successfully.</Use.Dont>
</Use>
...
<Use>
	...
	<Use.Do>The input definition is invalid. Check it is valid and it uses UTF-8 encoding.</Use.Do>
	<Use.Dont>A remote service is unavailable. Try again later or contact us.</Use.Dont>
	<Use.Dont>The input definition is invalid. Please check it is valid and it uses UTF-8 encoding.	</Use.Dont>
</Use>
