...
- Use body text to: - Informative empty states: tell users what will display here, with no direct actions from them - Actionable empty states: guide users towards taking the next step when there's an action they can take
...
- Include an informative title
- Use body text to: - Informative empty states: tell users what will display here, with no direct actions from them - Actionable empty states: guide users towards taking the next step when there's an action the user can take
- (Optional but preferred) Include a "Learn more" link to the documentation if the feature is documented
