...
<Meta
	...
	parameters={{
		status: { figma: 'ok', storybook: 'ok', react: 'wip', i18n: 'wip' },
...
<FigmaImage
	src="https://www.figma.com/file/6XBBCBVOhyX6yTaNcZQiti/Empty-States?node-id=68%3A3540"
...
<Canvas withSource="closed">
	<Story story={Stories.Usage} name="Variant component" />
</Canvas>

<ArgsTable story="Variant component" />
