	...
	return (
		...
		>
			<path
				...
				stroke="var(--coral-color-illustration-color-04)"
				strokeWidth="6"
				strokeLinecap="round"
			/>
			<circle cx="49.873" cy="66.361" r="8" fill="var(--coral-color-illustration-color-03)" />
			<circle cx="280.75" cy="127.547" r="10" fill="var(--coral-color-illustration-color-03)" />
			<circle cx="108.568" cy="168.869" r="10" fill="var(--coral-color-illustration-color-03)" />
			<circle cx="202.627" cy="187.555" r="3" fill="var(--coral-color-illustration-color-04)" />
			<circle cx="77.154" cy="171.156" r="3" fill="var(--coral-color-illustration-color-04)" />
			<circle cx="66.824" cy="164.27" r="3" fill="var(--coral-color-illustration-color-04)" />
			<circle cx="60.824" cy="118.27" r="3" fill="var(--coral-color-illustration-color-04)" />
			<circle cx="217.551" cy="186.406" r="3" fill="var(--coral-color-illustration-color-04)" />
			<path
				...
				fill="var(--coral-color-illustration-color-01)"
			/>
			<path
				...
				fill="var(--coral-color-illustration-color-05)"
			/>
			<path
			...
			<path
				...
				fill="var(--coral-color-illustration-color-02)"
			/>
			<path
			...
			<path
				...
				fill="var(--coral-color-illustration-skintone-02)"
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
			...
			<path
				...
				fill="var(--coral-color-illustration-color-06)"
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
