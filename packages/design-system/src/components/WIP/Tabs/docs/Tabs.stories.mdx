...
import { Tag, TagInformation } from '../../../Tag';
...
>
	<InlineMessageWarning
		title="Early API"
		withBackground
		description="This component works for simple tabs but doesn't handle every usecase. API may break."
	/>
</StackVertical>
	...
	<Story name="tabs-with-tags">
		<Tabs selectedId="tab2">
			<Tabs.TabList aria-label="My tabs">
				...
				<Tabs.Tab id="tab2">
					Calendar <TagInformation>54</TagInformation>
				</Tabs.Tab>
				<Tooltip title="Display 1534 favorites" placement="top">
					<Tabs.Tab>
