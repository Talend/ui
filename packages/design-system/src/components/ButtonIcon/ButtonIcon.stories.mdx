...
import InlineMessage from '../InlineMessage/index';
...
function MyComponent() {
	return (
		<>
			<ButtonIcon onClick={onAddDataset()}>Add a dataset</ButtonIcon>
			<ButtonIcon onClick={onAddDataset()} size="S" disabled>
				Add a dataset
			</ButtonIcon>
			<ButtonIcon onClick={onAddDataset()} size="XS">
				Add a dataset
			</ButtonIcon>
			<ButtonIcon onClick={onAddDataset()} isLoading>
				Add a dataset
			</ButtonIcon>
		</>
	);
...
function MyComponent() {
	return (
		<>
			<ButtonToggle isActive={false} onClick={onToggleEditMode()}>
				Edit this dataset
			</ButtonToggle>
			<ButtonToggle isActive={false} onClick={onToggleEditMode()} size="S" disabled>
				Edit a dataset
			</ButtonToggle>
			<ButtonToggle isActive={false} onClick={onToggleEditMode()} size="S" isLoading>
				Edit a dataset
			</ButtonToggle>
		</>
	);
...
function MyComponent() {
	return (
		<>
			<ButtonIconFloating onClick={onAddDataset()}>Add a dataset</ButtonIconFloating>
			<ButtonIconFloating onClick={onAddDataset()} size="S" disabled>
				Add a dataset
			</ButtonIconFloating>
			<ButtonIconFloating onClick={onAddDataset()} isLoading>
				Add a dataset
			</ButtonIconFloating>
		</>
	);
