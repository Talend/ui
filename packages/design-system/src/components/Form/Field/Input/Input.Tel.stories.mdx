...
<Canvas>
	<Story name="filled">
		<Form.Tel name="tel" label="Tel" value="123-456-7890" />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="disabled">
		<Form.Tel name="tel" label="Tel" value="123-456-7890" disabled />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="read-only">
		<Form.Tel name="tel" label="Tel" value="123-456-7890" readOnly />
	</Story>
</Canvas>
