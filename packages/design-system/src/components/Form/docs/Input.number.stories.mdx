...
<Meta
	title="Components/Form/Fields/Number"
	parameters={{
...
<Canvas>
	<Story name="default">
		<Form.Number name="number" label="Number" min="10" max="100" />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="filled">
		<Form.Number name="number" label="Number" value="25" min="10" max="100" />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="disabled">
		<Form.Number name="number" label="Number" value="25" min="10" max="100" disabled />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="read-only">
		<Form.Number name="number" label="Number" value="25" min="10" max="100" readOnly />
	</Story>
</Canvas>
