...
<Meta
	title="Components/Form/Fields/Datalist"
...
<Canvas>
	<Story name="default">
		<Form.Datalist name="datalist" label="Datalist" values={['', 'foo', 'bar']} />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="disabled">
		<Form.Datalist name="datalist" label="Disabled Datalist" disabled values={['', 'foo', 'bar']} />
	</Story>
</Canvas>
