...
Toggle switches are a quick way to view and switch between two states or on-off state instantly.

## Zoning

<FigmaImage
	src="https://www.figma.com/file/aU5vb0rhuaqtMIkmJynb9W/mhuet%2Ftoggle?node-id=1749%3A152"
	alt="zoning image for toggle switch"
/>
