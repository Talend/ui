...
<Meta
	title="Components/Form/Fields/Email"
	parameters={{
...
<Canvas>
	<Story name="default">
		<Form.Email label="Email" name="email" placeholder="user@domain.com" />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="filled">
		<Form.Email label="Email" name="email" value="user@talend.com" />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="disabled">
		<Form.Email label="Email" name="email" value="user@talend.com" disabled />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="read-only">
		<Form.Email label="Email" name="email" value="user@talend.com" readOnly />
	</Story>
</Canvas>
