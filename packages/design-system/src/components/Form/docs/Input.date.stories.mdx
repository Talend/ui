...
<Meta
	title="Components/Form/Fields/Date"
	parameters={{
...
<Canvas>
	<Story name="default">
		<Form.Date name="date" label="Date" value="2018-07-22" min="2018-01-01" max="2018-12-31" />
	</Story>
</Canvas>
...
<Canvas withSource="none">
	...
	>
		<Form.Date name="date" label="Date" />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="filled">
		<Form.Date name="date" label="Date" value="09:00" />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="disabled">
		<Form.Date name="date" label="Date" value="09:00" disabled />
	</Story>
</Canvas>
...
<Canvas>
	<Story name="read-only">
		<Form.Date name="date" label="Date" value="09:00" readOnly />
	</Story>
</Canvas>
