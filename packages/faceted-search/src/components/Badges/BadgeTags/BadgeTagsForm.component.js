		...
		<React.Fragment>
			...
			{!isLoading && (
				<form
					...
					onSubmit={onSubmit}
				>
					<Rich.RichLayout.Body id={badgeTagsFormId} className={theme('fs-badge-tags-form-body')}>
						{!visibleTags.length && (
					...
					</Rich.RichLayout.Body>
					<Rich.RichLayout.Footer id={id} className={theme('fs-badge-tags-form-footer')}>
						<div>
							{value.length > 0 && (
								<Action
									type="button"
