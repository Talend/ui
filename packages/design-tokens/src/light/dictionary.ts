...
Default: Source Sans Pro, 18px, Semibold`,
...
Default: Source Sans Pro, 14px, Regular`,
...
Default: Source Sans Pro, 14px, Semibold`,
...
Default: Source Sans Pro, 12px, Regular`,
...
Default: Source Sans Pro, 16px, Semibold`,
...
Default: 250ms ease-in-out`,
    ...
    },
    {
        ...
        type: 'transition',
        description: `Normal transition for "in" effect (opening menu, show modal, ...)
...
Default: 4`,
    ...
    },
    {
        ...
        type: 'elevation',
        description: `Behind any layout (dropdown, popover, tooltip)
...
Default: 8`,
    ...
    },
    {
        ...
        type: 'elevation',
        description: `Behind anything else (Alert, Confirm, etc.)
