const tokens = {
  ...
  coralColorBrandingBackground: `var(--coral-color-branding-background, linear-gradient(144.29deg,hsla(222,49%,14%,1) 0%, hsla(253,46%,8%,1) 100%))`,
  coralColorBrandingNavigation: `var(--coral-color-branding-navigation, linear-gradient(144.53deg,hsla(222,49%,14%,1) 0%, hsla(253,46%,8%,1) 100%))`,
