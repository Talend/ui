...
A content type defines metadata over content. For example when you display a list of article you say each item in this list are an _article_ which is a content type.
...
[Sagas provided by CMF](https://github.com/Talend/react-cmf/blob/master/sagas/sagas.md).
