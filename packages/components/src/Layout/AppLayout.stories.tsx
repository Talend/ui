...
export const TwoColumnsWithBigLargeList: Story = {
	render: () => (
		<Layout mode="TwoColumns" header={header} one={sidePanel}>
...
export const TwoColumnsDocked: Story = {
	render: () => (
		<Layout mode="TwoColumns" header={header} one={dockedSidePanel} children={content} />
	),
};

export const TwoColumnsWithDrawers: Story = {
	render: () => (
		<Layout
			mode="TwoColumns"
			header={header}
...
export const OnlySubheader: Story = {
