...
export const DefaultMultiSection: Story = {
	render: () => {
		const restrictedValues = { ...propsMultiSection, restricted: true };
		const defaultValue = { ...propsMultiSection, value: 'lol' };
		const withIcons = {
			...propsMultiSection,
			titleMap: propsMultiSection.titleMap.map((titleMap: any) => ({
				...titleMap,
				suggestions: titleMap.suggestions.map((suggestion: any) => ({
					...suggestion,
...
export const DefaultSingleSection: Story = {
	render: () => {
		...
		const withIcons = {
			...singleSectionProps,
			titleMap: singleSectionProps.titleMap.map((titleMap: any, i: number) => ({
				...titleMap,
				icon: {
