...
export default class Mapper extends Component {
  ...
  render() {
    const {inputSchema, mapping, outputSchema, performMapping, clearMapping, clearConnection, draggable, selection, onSelect} = this.props
    return (
      <div id='mapper'>
        <Schema
          ref={(input) => { this.inputSchema = input }}
        ...
        />
        <Schema
          ref={(output) => { this.outputSchema = output }}
