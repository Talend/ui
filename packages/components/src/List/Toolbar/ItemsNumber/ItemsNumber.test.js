...
describe('ItemsNumber', () => {
	it('should render table with total number of items', () => {
		// when
	...
	it('should render table with total number of items + customized title', () => {
		// when
	...
	it('should render table with total number of items + number of selected items', () => {
		// when
