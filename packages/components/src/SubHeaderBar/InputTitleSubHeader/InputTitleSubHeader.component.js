...
function InlineFormSubHeader({ title, inputTextValue, onSubmit, onCancel, onChange, t }) {
	return (
...
InlineFormSubHeader.defaultProps = {
	t: getDefaultTranslate,
};
...
export { InputTitleSubHeader as default, InlineFormSubHeader, TitleSubHeader, selectInput };
