...
describe('SubHeaderBarActions', () => {
	...
	it('should render with center props', () => {
		...
		const contents = wrapper.find(ActionBar.Content);
		expect(contents).toHaveLength(3);
		expect(contents.get(0).props.center).toEqual(true);
		expect(contents.get(1).props.center).toEqual(true);
		expect(contents.get(2).props.center).toEqual(true);
	...
	it('should render with right props', () => {
		...
		const contents = wrapper.find(ActionBar.Content);
		expect(contents).toHaveLength(3);
		expect(contents.get(0).props.right).toEqual(true);
		expect(contents.get(1).props.right).toEqual(true);
		expect(contents.get(2).props.right).toEqual(true);
		expect(wrapper.find(Icon)).toHaveLength(1);
		expect(wrapper.find(Action)).toHaveLength(2);
	});
});
