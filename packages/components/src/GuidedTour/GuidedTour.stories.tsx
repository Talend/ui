...
const TranslatedGuidedTourContainer = withTranslation(I18N_DOMAIN_COMPONENTS)(
	GuidedTourContainer as any,
);
	...
	return [
		...
		},
		{
			...
			content: {
				...
				body: ({ goTo, step }: { goTo: (step: number) => void; step: number }) => (
					<ImportDemo
