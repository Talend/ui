...
const props = {
	...
	list: {
		columns: [
			...
			{ key: 'name', selector: 'meta.name', label: 'Name', order: 1 },
			{ key: 'author', selector: 'meta.author', label: 'Author', order: 3 },
			{ key: 'created', selector: 'meta.created', label: 'Created', order: 2 },
			{
				key: 'modified',
				selector: 'meta.modified',
				label: 'Modified',
				order: 4,
				header: 'icon',
				data: { iconName: 'talend-scheduler' },
			},
			{ key: 'meta.icon', label: 'Icon', hidden: true, order: 5 },
		],
		items: [
			{
				id: 0,
