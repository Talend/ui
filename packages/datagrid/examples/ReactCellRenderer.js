...
import sampleData from '../.storybook/sample.json';
import {
	NAMESPACE_INDEX,
	NAMESPACE_SAMPLE,
	COLUMN_INDEX,
...
export default function ReactCellRenderer() {
	return (
		<div style={{ height: '100vh' }}>
			<IconsProvider />
			<DataGrid
				columnDefs={getColumnDefs(sampleData)}
				...
				pinnedColumnDefs={getPinnedColumnDefs(sampleData)}
				rowData={getRowData(sampleData)}
