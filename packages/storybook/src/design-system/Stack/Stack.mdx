...
import * as StoriesHorizontal from '@talend/design-system/lib/stories/StackHorizontal.stories';
import * as StoriesVertical from '@talend/design-system/lib/stories/StackVertical.stories';
...
<Canvas>
	<Story story={StoriesHorizontal.TestHorizontal} name="Story Horizontal" />
</Canvas>

<ArgsTable story="Story Horizontal" />
...
<Canvas>
	<Story
		story={StoriesHorizontal.TestHorizontalWithExplicitSpacing}
		name="Story Horizontal Spacing"
	/>
</Canvas>

<ArgsTable story="Story Horizontal Spacing" />
...
<Canvas>
	<Story story={StoriesVertical.TestVertical} name="Story Vertical" />
</Canvas>

<ArgsTable story="Story Vertical" />

### Nesting Stacks to compose a layout

<Canvas>
	<Story story={StoriesVertical.StackNesting} />
</Canvas>

### Using StackItem

<Canvas>
	<Story story={StoriesVertical.StackWithStackItem} name="Story StackItem" />
</Canvas>

<ArgsTable story="Story StackItem" />
