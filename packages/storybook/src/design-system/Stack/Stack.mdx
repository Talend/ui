...
import * as StoriesHorizontal from '@talend/design-system/src/stories/StackHorizontal.stories';
import * as StoriesVertical from '@talend/design-system/src/stories/StackVertical.stories';
