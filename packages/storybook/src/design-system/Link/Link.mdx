...
import * as Stories from '@talend/design-system/lib/stories/Link.stories';
import * as StoriesButton from '../LinkAsButton/LinkAsButton.stories';
...
<ArgsTable story="Link as Button" />
