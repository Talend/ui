...
import { EmptyStatePrimitive } from '@talend/design-system';

import * as Stories from '@talend/design-system/lib/components/EmptyState/EmptyState.stories';
...
<Canvas>
	<Story story={Stories.MediumWithAction} name="Medium usage" />
</Canvas>

<ArgsTable story="Medium usage" />
