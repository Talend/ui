...
import { ButtonPrimary, Form, InlineMessageInformation } from '@talend/design-system';
import * as Stories from '@talend/design-system/src/stories/Affix.stories';

<Meta
	title="Design System/Form/Form Fields/Prefix, Suffix"
	parameters={{
