...
import { InlineMessage } from '@talend/design-system';
import * as Stories from '@talend/design-system/src/stories/InlineMessage.stories';

<Meta
	title="Design System/Inline Message"
