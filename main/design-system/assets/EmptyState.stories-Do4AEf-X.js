...
`:""}
  ...
  href: 'https://talend.com'
}} />`,...p.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => <BrowserRouter>
        <EmptyStateLarge title="No preparations yet" description="Add a preparation to clean, format, and transform data prior to processing." action={{
    ...
    </BrowserRouter>`,...d.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`({
  illustration,
  title,
  description,
  link,
  ...
  return <EmptyStateMedium illustration={illustration} title={title} description={description} link={link} action={action} />;
}`,...s.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:'() => <EmptyStateSmall title="Create a preparation first" />',...h.parameters?.docs?.source}}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`() => <StackHorizontal gap="XS" align="center" justify="spaceBetween">
    ...
    </StackHorizontal>`,...E.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`(args: EmptyStateProps) => {
  switch (args.variant) {
    case 'L':
      {
        const {
...
}`,...c.parameters?.docs?.source}}};const it=["Large","LargeWithLinkButton","MediumWithAction","Small","Demo","Usage"],ut=Object.freeze(Object.defineProperty({__proto__:null,Demo:E,Large:p,LargeWithLinkButton:d,MediumWithAction:s,Small:h,Usage:c,__namedExportsOrder:it,default:at},Symbol.toStringTag,{value:"Module"}));export{E as D,p as L,s as M,ut as S,c as U,h as a,d as b};
