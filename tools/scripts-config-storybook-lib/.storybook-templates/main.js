...
const defaultMain = {
	...
	staticDirs: [path.join(__dirname, 'msw'), require.resolve('@talend/icons').replace('/dist/index.cjs', '/dist/svg-bundle').replace('index.js', '').replace('/dist/TalendIcons.js', '/dist/svg-bundle')],
	addons: [
