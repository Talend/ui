...
**The component can be use within and internationalized application or not. We import a default i18n configuration that will be ignored if one is provided in the context by react-i18next provider.**
